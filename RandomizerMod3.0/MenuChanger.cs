...
namespace RandomizerMod
{
    internal static class MenuChanger
    {
        ...
        public static void EditUI()
        {
            ...
            RandoRootsBtn.Button.SetNavigation(RandoStagBtn.Button, RandoRootsBtn.Button, RandoGeoRocksBtn.Button, RandoGrubBtn.Button);
            RandoGeoRocksBtn.Button.SetNavigation(RandoGrubBtn.Button, RandoGeoRocksBtn.Button, RandoSoulTotemsBtn.Button, startRandoBtn);
