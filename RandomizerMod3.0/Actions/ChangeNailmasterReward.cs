...
namespace RandomizerMod.Actions
{
    public class ChangeNailmasterReward : RandomizerAction
    {
        ...
        public ChangeNailmasterReward(string sceneName, string objectName, string fsmName, string nameKey, string spriteName, GiveAction action, string item, string location)
        {
